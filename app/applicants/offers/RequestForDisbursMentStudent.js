        ...
        amount_approve)
            ...
            const insertSql = `
                INSERT INTO disbursement_requests (
                    ...
                    b_schoolAccountName, b_schoolAccountNumber,b_schoolName, c_studentName,c_schoolAccountNumber, c_bank,c_amount, c_branch,
    ...
    db.query(checkSql, [user_token], (err, result) => {
        ...
        const updateSql = `
            UPDATE disbursement_requests SET
                ...
                c_studentName = ?, c_schoolAccountNumber = ?, c_bank = ?, c_amount = ?, c_branch = ?, c_course = ?, 
